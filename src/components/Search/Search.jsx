...
function Search() {
  ...
  const handleLocationChange = (event) => {
    setSelectedValues((prevValues) => ({ ...prevValues, location: event.target.value }));
  };
...
<Path loc={LocArray} />
  ...
  <>
     ...
     <Button variant="primary" className="d-lg-none custom-filter-btn" onClick={handleShow}
     >
  ...
  {selectedValues.location && (
    <div className="tag" >
      ...
      {selectedValues.location} <span onClick={() => handleRemoveTag('location','location')}><XCircleFill color="grey"/></span>
      </div>
  )}
  {selectedValues.bodyTypes.map((type) => (
    ...
    <div key={type} className="tag" >
      {type}
    </div><span onClick={() => handleRemoveTag(type,'bodyTypes')}><XCircleFill color="grey"/></span></>
  ))}
  {selectedValues.fuelTypes.map((type) => (
    <>
    <div key={type} className="tag">
      {type}
    </div><span onClick={() => handleRemoveTag(type,'fuelTypes')}><XCircleFill color="grey"/></span></>
  ))}
  {selectedValues.transmission.map((type) => (
   <> <div key={type} className="tag" >
      {type}
    </div>
     <span onClick={() => handleRemoveTag(type,'transmission')}><XCircleFill color="grey"/></span></>
  ))}
  {selectedValues.condition.map((type) => (
    ...
    <span onClick={() => handleRemoveTag(type,'condition')}><XCircleFill color="grey"/></span></>
  ))}
  {selectedValues.colors.map((color) => (
    <div key={color} className="tag" style={{ backgroundColor: color }}>
      {color}
    </div>
...
</div><span onClick={() => handleRemoveTag('yearFrom')}><XCircleFill color="grey"/></span></>}
 
{selectedValues.year.to &&  
<>  <div className="tag" >
  { `To: ${selectedValues.year.to}`}
</div><span onClick={() => handleRemoveTag('yearTo')}><XCircleFill color="grey"/></span></>}
...
<hr/>
            ...
            <div>
              <div>Select Location
                <Form.Select className="custom-select mb-2" onChange={handleLocationChange} value={selectedValues.location}>
             ...
             <br/>
              ...
              <div className="checkboxList">
                ...
                {CarBody.map((type) => (
                  <Form.Check
                    ...
                    id={type}
                    label={type}
                    checked={selectedValues.bodyTypes.includes(type)}
                ...
                <div className="checkboxList">
                  {FuelTypes.map((type) => (
                    <Form.Check
                      ...
                      id={type}
                      label={type}
                      checked={selectedValues.fuelTypes.includes(type)}
                ...
                <div className="checkboxList">
                  {Transmission.map((type) => (
                    <Form.Check
                      ...
                      id={type}
                      label={type}
                      checked={selectedValues.transmission.includes(type)}
              ...
              <div>Year
                <Row>
                  <Col>
                <Form.Select className="custom-select mb-2" onChange={(e) => handleYearChange(e, 'from')} value={selectedValues.year.from}>
                  ...
                  <Col>
                <Form.Select className="custom-select mb-2" onChange={(e) => handleYearChange(e, 'to')} value={selectedValues.year.to}>
              ...
              <div>
                ...
                <div className="checkboxList">
                  <Form.Check
                    ...
                    id='new'
                    label='New'
                    checked={selectedValues.condition.includes('New')}
                  ...
                  <Form.Check
                    ...
                    id='used'
                    label='Used'
                    checked={selectedValues.condition.includes('Used')}
