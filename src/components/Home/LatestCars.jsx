...
<Button style={{border:'none',borderRadius:'100%',zIndex:'1',top:'20%',marginRight:'5%'}} onClick={pressprev}>
        &lt;
      </Button>
...
<Button style={{ border:'none',borderRadius:'100%',marginLeft:'5%',zIndex:'1'}}  onClick={pressnext} >
        &gt;
      </Button>
<br></br>
