...
function Header() {
  ...
  return (
    ...
    <Navigation/>
    <div className='Header' style={{ backgroundColor: 'transparent', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <div>
      <animated.div style={{ display: 'block', ...line1 }}>
        <h1>FIND<b>THE</b> <br />
          <b>RIGHT</b> 
         CAR<br />RIGHT<b>HERE</b> </h1>
      </animated.div>
      </div>
      
      <div>

      <animated.div style={{marginTop:'10em',
      ...car}}>
