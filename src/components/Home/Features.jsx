...
<Col style={itemStyle1}><ListGroup.Item className={styles.customListItem} bsPrefix="customListItem">
...
<Col style={itemStyle2}><ListGroup.Item className={styles.customListItem} bsPrefix="customListItem">
